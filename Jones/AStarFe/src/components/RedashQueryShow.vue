...
<!--    style="height:780px !important; margin-left: -20px;margin-right: -20px; margin-top: -5px">-->
    ...
    <h3 style="display:none">
        This is redashQuery/{{$route.params.queryid}}
    </h3>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    created: function () {
      ...
      this.url_src = self.$route.params.queryUrl
      console.log('redashQueryUrl:'+this.url_src)
      if (this.url_src == null || this.url_src.length == 0) {
    ...
    beforeUpdate: function () {
      ...
      this.url_src = this.$route.params.queryUrl
    },
