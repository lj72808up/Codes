...
<!--    style="height:780px !important; margin-left: -20px;margin-right: -20px; margin-top: -5px">-->
    ...
    <h3 style="display:none">
        This is dashboard/{{$route.params.dashboardname}}
    </h3>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    created: function () {
      ...
      this.url_src = self.$route.params.dashboardUrl
      console.log('dashboardUrl:'+this.url_src)
      self.isShowFrame = true
    ...
    beforeUpdate: function () {
      ...
      this.url_src = this.$route.params.dashboardUrl
    },
